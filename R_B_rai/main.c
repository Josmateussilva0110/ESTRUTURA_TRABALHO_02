    ...
    do
    {
        ...
        switch (op)
        {
            ...
            case 1:
                ...
                limparBuffer();
                insere_Artista(&arvore, nome, estilo, numero_album);
                break;
            case 2:
            ...
            case 5:
                    ...
                    switch (op_busca)
                    {
                        ...
                        case 3:
                            ...
                            encontrar_artistas_e_albuns_pela_musica(arvore, nome_musica1);
            ...
            case 6: 
                ...
                switch (op_remocao)
                {
                    case 1:
                        ...
                        fgets(nome_artista1, sizeof(nome_artista1), stdin);
                        nome_artista1[strcspn(nome_artista1, "\n")] = '\0';
                        remove_ArvLLRB(&arvore, nome_artista1); 
                        break;
                    case 2:
                        printf("Nome do artista para remover o album: ");
                        fgets(nome_artista1, sizeof(nome_artista1), stdin);
                        nome_artista1[strcspn(nome_artista1, "\n")] = '\0';
                        ...
                        fgets(nome_album, sizeof(nome_album), stdin);
                        nome_album[strcspn(nome_album, "\n")] = '\0';
                        remover_album_por_nome_artista_titulo(arvore,nome_artista1,nome_album);
                        break;
                    case 3:
                        printf("Nome do artista para remover a musica: ");
                        fgets(nome_artista1, sizeof(nome_artista1), stdin);
                        nome_artista1[strcspn(nome_artista1, "\n")] = '\0';
                        
                        printf("Nome do album para remover a musica: ");
                        fgets(nome_album, sizeof(nome_album), stdin);
                        nome_album[strcspn(nome_album, "\n")] = '\0';
                        ...
                        remover_musica_do_album_artista(arvore, nome_artista1, nome_album, nome_musica1);
                        break;
                    case 0:
                        break;
                    default:
